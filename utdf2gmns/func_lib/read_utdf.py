...
def read_UTDF_file(path_utdf: str) -> dict:
    ...
    # utdf_dict_data["phase_timePlans"] = pd.concat([utdf_dict_data.get("Phases"),
    # utdf_dict_data.get("Timeplans")], axis=0, ignore_index=True)
...
if __name__ == '__main__':
    ...
    path_utdf = path2linux(os.path.join(
        path_project_folder, "datasets/data_ASU_network_2/UTDF.csv"))
